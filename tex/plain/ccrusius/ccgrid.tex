...
%
\def\ccgridsetup{
  \typeout{ccgrid: original baselineskip=\the\baselineskip\space vsize=\the\vsize}
  %
  % Remove glue from \baselineskip
  %
  \global\baselineskip=\directlua{tex.print(ccbase.spstr(ccbase.tosp("\the\baselineskip")))}
  ...
  \typeout{ccgrid: new baselineskip=\the\baselineskip\space vsize=\the\vsize}
  \raggedbottom% We do our own thing, but let's tell others this is the intent
  \lineskip0pt
  \lineskiplimit-0.5\baselineskip
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatother
\ccgridsetup
